import {
    TealHeader, WhiteHeader, Navbar, Footer, UserDashboardCard, UserDashboardCardUp, UserDashboardCardDown, DashboardNavbar, WhiteButton
} from "../../../components";
        ...
        <>
            ...
            <section id="userstat">
                <div className="content">
                    ...
                    <div className="grid md:grid-cols-3 md:gap-x-4 gap-14 xl:gap-x-28">
                        <div className="">
                            <UserDashboardCard number="40" title="Total Penukaran" explanation="Ayo tingkatkan penukaran!" />
                        </div>
                        <div className="">
